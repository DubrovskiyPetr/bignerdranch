...
class CrimeFragment : Fragment(), DatePickerFragment.Callbacks {
    ...
    override fun onStart() {
        ...
        suspectButton.apply {
            ...
            val resolvedActivity: ResolveInfo? = packageManager.resolveActivity(pickContactIntent, MATCH_DEFAULT_ONLY)
        ...
        photoButton.apply {
            ...
            val resolvedActivity: ResolveInfo? = packageManager.resolveActivity(captureImage, MATCH_DEFAULT_ONLY)
            if (resolvedActivity == null) {
                isEnabled = false
            }
            setOnClickListener {
                captureImage.putExtra(MediaStore.EXTRA_OUTPUT, photoUri)
                val cameraActivities: List<ResolveInfo> = packageManager.queryIntentActivities(captureImage, MATCH_DEFAULT_ONLY)
